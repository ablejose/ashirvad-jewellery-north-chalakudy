...
export const BRAND: BrandConfig = {
  ...
  description:
    "Ashirvad Jewellery is Chalakudy's trusted destination for exquisite gold, diamond, and silver jewellery. Serving Chalakudy and the surrounding areas with timeless craftsmanship and contemporary designs for every celebration.",
  ...
  seo: {
    ...
    description:
      "Ashirvad Jewellery — your premier jewellery store in Chalakudy. Gold, diamond and silver jewellery crafted for every occasion. Visit us in Chalakudy, Kerala.",
    keywords: [
      "Ashirvad Jewellery",
      "jewellery Chalakudy",
