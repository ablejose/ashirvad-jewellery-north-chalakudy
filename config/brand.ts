...
export const BRAND: BrandConfig = {
  ...
  description:
    "Ashirvad Jewellery is Chalakudy's trusted destination for gold, diamond and silver jewellery. Serving Chalakudy with timeless craftsmanship and exquisite collections for every celebration.",
  ...
  seo: {
    title: "Ashirvad Jewellery | Jewellery Store in Chalakudy",
    description:
      "Ashirvad Jewellery — your trusted destination for gold, diamond and silver jewellery in Chalakudy, Kerala.",
    keywords: [
      "Ashirvad Jewellery",
      "jewellery Chalakudy",
